...
create table fragmento_rutina (duracion_minutos bigint, ejercicios_id bigint, id bigint not null, repeticiones bigint, series bigint, primary key (id));
...
alter table if exists fragmento_rutina add constraint FKiwqgk2doq7bbvjerkjhjb3dsh foreign key (ejercicios_id) references ejercicio;
